  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'enzyme_sphinx_theme/static/fonts/FreightSans',
              filter: 'isFile'
          },

          {
              ...
              dest: 'enzyme_sphinx_theme/static/fonts/IBMPlexMono',
              filter: 'isFile'
          }
        ]
      },
        ...
        files: [
          {
              ...
              flatten: true,
              src: ['images/*'],
              dest: 'enzyme_sphinx_theme/static/images',
              filter: 'isFile'
          }
        ]
      },
        ...
        files: [
          {
            ...
            dest: 'enzyme_sphinx_theme/static/js/vendor',
            filter: 'isFile'
          }
        ]
      }
    ...
    browserify: {
      dev: {
        options: {
          external: ['jquery'],
          alias: {
            'enzyme-sphinx-theme': './js/theme.js'
          }
        },
        src: ['js/*.js'],
        dest: 'enzyme_sphinx_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    uglify: {
      dist: {
        ...
        files: [{
          expand: true,
          src: ['enzyme_sphinx_theme/static/js/*.js', '!enzyme_sphinx_theme/static/js/*.min.js'],
          dest: 'enzyme_sphinx_theme/static/js/',
    ...
    clean: {
      build: ["docs/build"],
      fonts: ["enzyme_sphinx_theme/static/fonts"],
      images: ["enzyme_sphinx_theme/static/images"],
      js: ["enzyme_sphinx_theme/static/js/*", "!enzyme_sphinx_theme/static/js/modernizr.min.js"]
    },

    watch: {
      /* Changes in theme dir rebuild sphinx */
      sphinx: {
        files: ['enzyme_sphinx_theme/**/*', 'README.rst', 'docs/**/*.rst', 'docs/**/*.py'],
